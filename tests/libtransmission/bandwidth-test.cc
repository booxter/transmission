...
TEST_F(BandwidthTest, forceUploadPeerKeepsBootstrapRunwayFromHigh)
{
...
TEST_F(BandwidthTest, optimisticHistoricalForceUploadPressureReservesSyncBudgetFromHigh)
{
    ...
    EXPECT_EQ(0U, snapshot.high_piece_bytes);
...
TEST_F(BandwidthTest, lateAsyncBorrowLetsHighPeerUseTailAfterForceQuiesces)
{
    setSinglePulseLimit(TR_UP);
