...
|:--|:--|:--
| `bandwidthPriority`   | number   | this torrent's bandwidth priority: `-1` low, `0` normal, `1` high, `2` force
...
| `bandwidthPriority` | number | torrent bandwidth priority: `-1` low, `0` normal, `1` high, `2` force
